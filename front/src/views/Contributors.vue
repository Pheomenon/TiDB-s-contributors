    ...
    <v-flex md3>
      <v-app style="background-color:gery lighten-1;" class="ma-n4">
        <v-container ml-5 mt-5>
          ...
          <v-text-field @change="getList()" v-model="condition.key" label="Search contributor's name" prepend-icon="search" class="ml-3 mr-12"></v-text-field>
          <v-col cols="12" sm="6">
            <v-date-picker @change="getList()" v-model="condition.dates" range landscape>
               <v-tooltip bottom>
